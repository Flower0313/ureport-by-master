...
public class DatasourceController extends AbstractReportBasicController {
    private final static String url = "jdbc:mysql://ht-bi-test.mysql.polardb.rds.aliyuncs.com:3306/dw_bi?useUnicode=true&characterEncoding=UTF-8";

    private final static String driver = "com.mysql.cj.jdbc.Driver";
    private final static String username = "user_bi";
    private final static String password = "H^4zzM8iVc&c";
