...
import com.ureport.ureportkeep.core.build.cell.down.DownExpandBuilder;
import com.ureport.ureportkeep.core.build.cell.right.RightExpandBuilder;
import com.ureport.ureportkeep.core.build.paging.BasePagination;
import com.ureport.ureportkeep.core.build.paging.Page;
import com.ureport.ureportkeep.core.build.paging.PagingBuilder;
...
public class ReportBuilder extends BasePagination implements ApplicationContextAware{
    ...
    public void buildCell(Context context,List<Cell> cells){
        ...
        for(Cell cell:cells){
            //dataList中是mysql查询出的分组数据
            List<BindData> dataList=context.buildCellData(cell);
            /*for (BindData bindData : dataList) {
                System.out.println(bindData.getDataList()+"=>>>>>>>>>>>>");
            }*/
